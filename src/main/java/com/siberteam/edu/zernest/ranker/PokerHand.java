...
public class PokerHand implements Comparable<PokerHand> {
    ...
    public PokerHand(String hand) {
        ...
        sameCombinationScore = findSameCombinationScore(getRanksValuesFrequencyMap(ranksList), maxDuplicatesCount);
    }
    ...
    private Map<Integer, Integer> getRanksValuesFrequencyMap(List<Rank> ranks) {
